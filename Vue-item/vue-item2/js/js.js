...
Vue.component('jindu', {
    ...
    data() {
        return {
            jindu_arr: [{ jindu: 5, tit: "收益率" }, { jindu: 85, tit: "注册用户" }, { jindu: 95, tit: "近期交易数量" }, { jindu: 70, tit: "注册用户" }, { jindu: 70, tit: "收益率" }, { jindu: 60, tit: "收益率" }]
        }
    }
})
    ...
    template: `
        <div>
            ...
            <div style="float:left;width:278px;line-height:36px;font-size:18px;">
                <div class="aside" style="height:605px;position:relative;background-color:#cdcdcd;">
                ...
                <div style="float:right;max-width:888px;border:1px solid #f7a21e;background-color:#ddd;box-sizing:border-box;">
...
Vue.component('newzixun', {
    template:`
        <div>
            ...
            <div style="margin:20px 50px;" class="clearfix">
                <div style="float:right;width:308px;line-height:36px;font-size:18px;">
                    <div class="aside" style="min-height:600px;position:relative;background-color:#cdcdcd;">
                        <div style="position: absolute;left: px;top: 37px;">
                            <img src="https://ccdn.goodq.top/caches/5298879a47437c1c6c5e6399b11eb6f3/aHR0cDovLzU4MWRhMDNiNDU2ZWQudDczLnFpZmVpeWUuY29tL3FmeS1jb250ZW50L3VwbG9hZHMvMjAxNi8xMC82YzYwYTY1YjFiZTJlYzczMGY2MjZlNTgzMDBlYTQ2NC5wbmc_p_p100_p_3D.png" alt="" style="width: 308px;">
                        </div>
                        <div style="background-color: #f7a21e;text-align:center;color:#fff;">
                            受益更多，风险更小
                        </div>
                        <div style=" width:100%;position: absolute;bottom: 30px;">
                            <a style=" display: block;width: 126px;height: 38px;line-height: 38px;margin: auto;border-radius: 5px;" class="zixun">
                                立即注册
                            </a>
                        </div>
                    </div>
                ...
                <div style="float: left; width: 988px;line-height:36px;font-size:18px;background-color:#cdcdcd;" class="clearfix">

                     <div style="background-color: #f7a21e;text-align:center;color:#fff;">
                            最新理财资讯
                     </div>
                    <zixuntxt :item="json"></zixuntxt>
                     <div style="padding: 32px 29px 0px;box-sizing: border-box;" v-for="(i,$index) in zixun_arr" @click="getelement(i),info=!info,fs2()" v-if="info" >
                         <div class="clearfix">
                             <div style="float: left;margin-right: 15px;">
                                 <a><img :src="i.img" alt=""></a>
                             </div>
                             <div style="float: left;width: 690px;">
                                 <h5 style="color: #757575;font-size: 18px;font-family: 微软雅黑;line-height: 18px;">{{i.tit}}</h5>
                                 <p style="color: #999999;font-size: 14px;line-height: 36px;">发布日期：2017-03-09 分类：News </p>
                                 <p style="color: #999999;font-size: 14px;line-height: 18px;">起飞页推崇用户自己创建网站并享受建站所带来的乐趣，因此我们为您准备了一套安全、稳定、不揪心的自助建站系统：在这里，您只需打字传图、用鼠标自由拖拽，便可在弹指间做出极具专业级别的网站。我们以全球首创的网页线性布局方案和傻瓜式图文编辑为核心，研发出这种颠覆传统的响应式网站制作方式，可以为您节约90%的建站时间。</p>
                                 <div style="text-align: right;">
                                     <a href="" style="color: #e79e2f;font-size: 16px; ">阅读正文</a>
                                 </div>
    ...
    data(){
        return{
            json:'',
            info:true,
            zixun_arr:[{img:"https://ccdn.goodq.top/caches/5298879a47437c1c6c5e6399b11eb6f3/aHR0cDovLzU4MWRhMDNiNDU2ZWQudDczLnFpZmVpeWUuY29tL3FmeS1jb250ZW50L3VwbG9hZHMvMjAxNi8xMS9mNGMxNGM3NDNhMThlZjc1YjJmNzU0ZjFkZDA2ZjMzNy0yMDB4MTMzLmpwZw_p_p100_p_3D_p_p100_p_3D.jpg",tit:"居民理财投资仍显“胆小“"},
                        {img:"https://ccdn.goodq.top/caches/5298879a47437c1c6c5e6399b11eb6f3/aHR0cDovLzU4MWRhMDNiNDU2ZWQudDczLnFpZmVpeWUuY29tL3FmeS1jb250ZW50L3VwbG9hZHMvMjAxNi8xMS81NzJiMzk2YmY5ZTZlNjljZDlkOTZjMjI2ZDRiMWU0ZC0yMDB4MTMzLmpwZw_p_p100_p_3D_p_p100_p_3D.jpg",tit:"看房选房速成秘籍：购房“菜鸟”一秒变达人"},
                        {img:"https://ccdn.goodq.top/caches/5298879a47437c1c6c5e6399b11eb6f3/aHR0cDovLzU4MWRhMDNiNDU2ZWQudDczLnFpZmVpeWUuY29tL3FmeS1jb250ZW50L3VwbG9hZHMvMjAxNi8xMS8wNGY1NTM1Njc0MTBiZjhlZGY1YzEwMmM1YmJkOTY3Ny0yMDB4MTMzLmpwZw_p_p100_p_3D_p_p100_p_3D.jpg",tit:"5“不”原则发大财 不抱土豪大腿不卖肾"},
                        {img:"https://ccdn.goodq.top/caches/5298879a47437c1c6c5e6399b11eb6f3/aHR0cDovLzU4MWRhMDNiNDU2ZWQudDczLnFpZmVpeWUuY29tL3FmeS1jb250ZW50L3VwbG9hZHMvMjAxNi8xMS84MDg1ODcwZmQ2YjYxNGU5ZTRjYmQzM2MxYzNhZWY0OC0yMDB4MTMzLmpwZw_p_p100_p_3D_p_p100_p_3D.jpg",tit:"2017经济适用男/女标准出炉：你满足几条?"},
                        {img:"https://ccdn.goodq.top/caches/5298879a47437c1c6c5e6399b11eb6f3/aHR0cDovLzU4MWRhMDNiNDU2ZWQudDczLnFpZmVpeWUuY29tL3FmeS1jb250ZW50L3VwbG9hZHMvMjAxNi8xMS8wMDU1MTQ2MGFjNDU0YTNkYmUyYzUxYmE3OGJkZDdmNi0yMDB4MTMzLmpwZw_p_p100_p_3D_p_p100_p_3D.jpg",tit:"一块白布值两千万?奇葩XX作品还有很多!"}]
        }
    },
    mounted() {
        bus.$on('fn2', (a) => {
...
Vue.component('zixuntxt',{
    template:`
        <div class="zixuntxt" v-if="info">
            <h5 style="font-size: 18px;text-align: center;">{{json.tit}}</h5>
            <p style="font-size: 12px;text-align: center;color: #b7b7b7;">发布日期：2017-03-09 10:19</p>
            <div></div>
            <div style="font-size: 15px;">
                <p style="margin-bottom: 20px;">起飞页推崇用户自己创建网站并享受建站所带来的乐趣，因此我们为您准备了一套安全、稳定、不揪心的自助建站系统：在这里，您只需打字传图、用鼠标自由拖拽，便可在弹指间做出极具专业级别的网站。我们以全球首创的网页线性布局方案和傻瓜式图文编辑为核心，研发出这种颠覆传统的响应式网站制作方式，可以为您节约90%的建站时间。</p>
                <p style="margin-bottom: 20px;">起飞页的工作团队是一群热爱互联网及软件事业的大伙伴和小伙伴，经验丰富、成熟稳定，基于对网站出版行业的热爱、对人人都能做出精美网站的向往，公司投入一千万元人民币，历时两年时间打造出起飞页平台。截至2015年底，在起飞页上创建的网站已超过10万+。</p>
                <p style="margin-bottom: 20px;">起飞页推崇用户自己创建网站并享受建站所带来的乐趣，因此我们为您准备了一套安全、稳定、不揪心的自助建站系统：在这里，您只需打字传图、用鼠标自由拖拽，便可在弹指间做出极具专业级别的网站。我们以全球首创的网页线性布局方案和傻瓜式图文编辑为核心，研发出这种颠覆传统的响应式网站制作方式，可以为您节约90%的建站时间。</p>
                <p style="margin-bottom: 20px;">起飞页的工作团队是一群热爱互联网及软件事业的大伙伴和小伙伴，经验丰富、成熟稳定，基于对网站出版行业的热爱、对人人都能做出精美网站的向往，公司投入一千万元人民币，历时两年时间打造出起飞页平台。截至2015年底，在起飞页上创建的网站已超过10万+。</p>
            </div>
            <div style="margin-top: 70px;margin-bottom: 30px;">
                <span class="zixunspan" @click="info=!info,fs3()">返回列表</span>
            </div>
        </div>
    `,
    props:['item'],
...
var router = new VueRouter({
    routes: [{
            path: '/',
            component: { template: '#shouye' },
            data() {
                return {}
            }
        },
        { path: '/we', component: { template: '#we' } },
        { path: '/introduce', component: { template: '#introduce' }, },
        { path: '/counsel', component: { template: '#counsel' } },
        { path: '/recruit', component: { template: '#recruit' } },
